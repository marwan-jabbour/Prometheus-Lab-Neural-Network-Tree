...
public class DFS_Frame extends JFrame {

    public DFS_Panel panel;
     ...
     */
    public DFS_Frame(int width, int height, int size, int destX, int destY){
        this.panel=new DFS_Panel(width, height);
        panel.UNIT_SIZE=50;
